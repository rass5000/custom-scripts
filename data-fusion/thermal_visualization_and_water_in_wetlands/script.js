...
function setup() {
  return {
    input: [
      ...
      { datasource: "L1", bands: ["B10"] },

      { datasource: "L2", bands: ["B02", "B03", "B04", "B05", "B07"] },
    ],
...
function evaluatePixel(samples) {
  ...
  return L82.B05 < 0.1735 && L82.B07 < 0.1035
    ? [51 / 255, 68 / 255, 170 / 255]
    : [L82.B04 * 5, viz.process(val), viz.process(val)];
}

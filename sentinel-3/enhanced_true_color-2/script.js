...
if (result[0] > avg) {
  result[0] = result[0] - ((result[0] - avg) / 100) * saturation;
} else {
  result[0] = result[0] + ((avg - result[0]) / 100) * saturation;
}
if (result[1] > avg) {
  result[1] = result[1] - ((result[1] - avg) / 100) * saturation;
} else {
  result[1] = result[1] + ((avg - result[1]) / 100) * saturation;
}
if (result[2] > avg) {
  result[2] = result[2] - ((result[2] - avg) / 100) * saturation;
} else {
  result[2] = result[2] + ((avg - result[2]) / 100) * saturation;
}

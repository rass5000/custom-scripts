...
function applyEnh_V(bArr) {
  return satEnh_V([
    stretch(bArr[0], SminV, SmaxV),
    stretch(bArr[1], SminV, SmaxV),
    stretch(bArr[2], SminV, SmaxV),
  ]);
}
function applyEnh_I(bArr) {
  return satEnh_I([
    stretch(bArr[0], SminI, SmaxI),
    stretch(bArr[1], SminI, SmaxI),
    stretch(bArr[2], SminI, SmaxI),
  ]);
}
//==============================================================================
...
// SATURATION:
var SATU_V = 1.1; // standard=1.00; monochromatic=0; 2x=2.00
var SATU_I = 1.1; // standard=1.00; monochromatic=0; 2x=2.00
//------------------------------------------------------------------------------

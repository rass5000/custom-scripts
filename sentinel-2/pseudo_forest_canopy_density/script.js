...
let ndvi_lo = 0.2; // 0.20 for L1C (suggested value)
// 0.25 for L2A (suggested value)
let ndvi_hi = 0.4; // 0.40 for L1C (suggested value)
// 0.45 for L2A (suggested value)

// Shadow index (SI) high and low limits
let si_lo = 0.9; // 0.90 for L1C (suggested value)
...
if (ndvi > ndvi_hi && bi_1 < bi_hi && si > si_hi) return hi_forest;
else if (ndvi_hi > ndvi > ndvi_lo && bi_1 < bi_hi && si_hi > si > si_lo)
  return low_forest;
else if (ndvi > ndvi_lo) return grass_land;
else if (ndvi < ndvi_lo && bi_1 > bi_hi && si_lo > si) return bare_land;
else return other;
